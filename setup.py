...
def read_version_info():
    cmd = 'cd exkaldi_rt && python3 -c "import version; print(version.version.plain)"'
...
setup(
    ...
    description="ExKaldi-RT: An Online Speech Recognition Extension Toolkit based on Kaldi",
